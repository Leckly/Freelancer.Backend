...
namespace Freelancer.Backend.Infrastructure.Migrations
{
    ...
    [Migration("20250825165525_ChatTable")]
            ...
            modelBuilder.Entity("Freelancer.Backend.Domain.Job", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2025, 7, 26, 16, 55, 24, 3, DateTimeKind.Utc).AddTicks(4777),
                            ...
                            Price = 15000,
                            StartDate = new DateTime(2025, 8, 5, 16, 55, 24, 3, DateTimeKind.Utc).AddTicks(4784),
                            Status = 0,
                        ...
                        {
                            Id = 2,
                            CreateDate = new DateTime(2025, 8, 10, 16, 55, 24, 3, DateTimeKind.Utc).AddTicks(4823),
                            ...
                            Price = 4000,
                            StartDate = new DateTime(2025, 8, 15, 16, 55, 24, 3, DateTimeKind.Utc).AddTicks(4824),
                            Status = 1,
                        ...
                        {
                            Id = 3,
                            CreateDate = new DateTime(2025, 6, 26, 16, 55, 24, 3, DateTimeKind.Utc).AddTicks(4827),
                            ...
                            Price = 25000,
                            StartDate = new DateTime(2025, 7, 11, 16, 55, 24, 3, DateTimeKind.Utc).AddTicks(4827),
                            Status = 0,
                        ...
                        {
                            Id = 4,
                            CreateDate = new DateTime(2025, 7, 31, 16, 55, 24, 3, DateTimeKind.Utc).AddTicks(4829),
                            ...
                            Price = 7000,
                            StartDate = new DateTime(2025, 8, 10, 16, 55, 24, 3, DateTimeKind.Utc).AddTicks(4830),
                            Status = 1,
                        ...
                        {
                            Id = 5,
                            CreateDate = new DateTime(2025, 8, 15, 16, 55, 24, 3, DateTimeKind.Utc).AddTicks(4832),
                            ...
                            Price = 3000,
                            StartDate = new DateTime(2025, 8, 20, 16, 55, 24, 3, DateTimeKind.Utc).AddTicks(4833),
                            Status = 0,
                        ...
                        {
                            Id = 6,
                            CreateDate = new DateTime(2025, 7, 16, 16, 55, 24, 3, DateTimeKind.Utc).AddTicks(4836),
                            Description = "Aplikacja webowa analizująca SEO stron i generująca raporty dla klientów.",
                            Name = "System analizy SEO",
                            Price = 8000,
                            StartDate = new DateTime(2025, 7, 26, 16, 55, 24, 3, DateTimeKind.Utc).AddTicks(4836),
                            Status = 1,
                        ...
                        {
                            Id = 7,
                            CreateDate = new DateTime(2025, 8, 20, 16, 55, 24, 3, DateTimeKind.Utc).AddTicks(4839),
                            Description = "Implementacja modułu generowania raportów z kampanii marketingowych.",
                            Name = "Moduł raportowania danych",
                            Price = 2000,
                            StartDate = new DateTime(2025, 8, 27, 16, 55, 24, 3, DateTimeKind.Utc).AddTicks(4839),
                            Status = 0,
                        ...
                        {
                            Id = 8,
                            CreateDate = new DateTime(2025, 8, 5, 16, 55, 24, 3, DateTimeKind.Utc).AddTicks(4842),
                            Description = "Tworzenie nowoczesnego UI/UX dla aplikacji bankowej w Figma.",
                            Name = "Projekt interfejsu systemu bankowego",
                            Price = 12000,
                            StartDate = new DateTime(2025, 8, 15, 16, 55, 24, 3, DateTimeKind.Utc).AddTicks(4843),
                            Status = 0,
                            Tags = "[\"UI\",\"UX\",\"Figma\"]",
                            UserId = 14
                        },
                        ...
                        {
                            Id = 9,
                            CreateDate = new DateTime(2025, 8, 7, 16, 55, 24, 3, DateTimeKind.Utc).AddTicks(4845),
                            Description = "Projekt systemu do zarządzania klientami i negocjacjami handlowymi.",
                            Name = "System CRM dla firmy B2B",
                            Price = 6000,
                            StartDate = new DateTime(2025, 8, 13, 16, 55, 24, 3, DateTimeKind.Utc).AddTicks(4846),
                            Status = 1,
                        ...
                        {
                            Id = 10,
                            CreateDate = new DateTime(2025, 8, 18, 16, 55, 24, 3, DateTimeKind.Utc).AddTicks(4849),
                            Description = "Budowa platformy e-learningowej do szkoleń sprzedażowych.",
                            Name = "Aplikacja szkoleniowa online",
                            Price = 5000,
                            StartDate = new DateTime(2025, 8, 26, 16, 55, 24, 3, DateTimeKind.Utc).AddTicks(4849),
                            Status = 0,
                        ...
                        {
                            Id = 11,
                            CreateDate = new DateTime(2025, 7, 6, 16, 55, 24, 3, DateTimeKind.Utc).AddTicks(4851),
                            Description = "Wsparcie w prowadzeniu projektu IT z wykorzystaniem Scruma i Jiry.",
                            Name = "Koordynacja projektu w Agile",
                            Price = 9000,
                            StartDate = new DateTime(2025, 7, 16, 16, 55, 24, 3, DateTimeKind.Utc).AddTicks(4852),
                            Status = 1,
                        ...
                        {
                            Id = 12,
                            CreateDate = new DateTime(2025, 8, 3, 16, 55, 24, 3, DateTimeKind.Utc).AddTicks(4855),
                            Description = "Analiza luk bezpieczeństwa i wdrożenie rozwiązań DevSecOps.",
                            Name = "Audyt bezpieczeństwa aplikacji webowej",
                            Price = 11000,
                            StartDate = new DateTime(2025, 8, 10, 16, 55, 24, 3, DateTimeKind.Utc).AddTicks(4855),
                            Status = 0,
                        ...
                        {
                            Id = 13,
                            CreateDate = new DateTime(2025, 8, 13, 16, 55, 24, 3, DateTimeKind.Utc).AddTicks(4858),
                            Description = "Implementacja Prometheus i Grafana do monitorowania infrastruktury.",
                            Name = "System monitoringu serwerów",
                            Price = 5000,
                            StartDate = new DateTime(2025, 8, 18, 16, 55, 24, 3, DateTimeKind.Utc).AddTicks(4859),
                            Status = 1,
                        ...
                        {
                            Id = 14,
                            CreateDate = new DateTime(2025, 7, 21, 16, 55, 24, 3, DateTimeKind.Utc).AddTicks(4865),
                            Description = "Zbieranie wymagań i projektowanie modelu danych dla ERP.",
                            Name = "Analiza biznesowa systemu ERP",
                            Price = 14000,
                            StartDate = new DateTime(2025, 7, 31, 16, 55, 24, 3, DateTimeKind.Utc).AddTicks(4866),
                            Status = 0,
                        ...
                        {
                            Id = 15,
                            CreateDate = new DateTime(2025, 8, 17, 16, 55, 24, 3, DateTimeKind.Utc).AddTicks(4868),
                            Description = "Stworzenie architektury hurtowni danych dla systemu BI.",
                            Name = "Projekt hurtowni danych",
                            Price = 10000,
                            StartDate = new DateTime(2025, 8, 23, 16, 55, 24, 3, DateTimeKind.Utc).AddTicks(4869),
                            Status = 1,
                        ...
                        {
                            Id = 16,
                            CreateDate = new DateTime(2025, 8, 22, 16, 55, 24, 3, DateTimeKind.Utc).AddTicks(4879),
                            Description = "Projekt aplikacji webowej do obsługi zgłoszeń klientów.",
                            Name = "System zgłoszeń helpdesk",
                            Price = 1500,
                            StartDate = new DateTime(2025, 8, 24, 16, 55, 24, 3, DateTimeKind.Utc).AddTicks(4879),
                            Status = 0,
                        ...
                        {
                            Id = 17,
                            CreateDate = new DateTime(2025, 8, 23, 16, 55, 24, 3, DateTimeKind.Utc).AddTicks(4881),
                            Description = "Stworzenie panelu admina do zarządzania zgłoszeniami i SLA.",
                            Name = "Panel administracyjny dla helpdesk",
                            Price = 1000,
                            StartDate = new DateTime(2025, 8, 28, 16, 55, 24, 3, DateTimeKind.Utc).AddTicks(4882),
                            Status = 1,
                        ...
                        {
                            Id = 18,
                            CreateDate = new DateTime(2025, 8, 11, 16, 55, 24, 3, DateTimeKind.Utc).AddTicks(4885),
                            Description = "Budowa prostego CMS do zarządzania artykułami IT.",
                            Name = "System zarządzania treściami",
                            Price = 4500,
                            StartDate = new DateTime(2025, 8, 20, 16, 55, 24, 3, DateTimeKind.Utc).AddTicks(4885),
                            Status = 0,
                        ...
                        {
                            Id = 19,
                            CreateDate = new DateTime(2025, 8, 19, 16, 55, 24, 3, DateTimeKind.Utc).AddTicks(4887),
                            Description = "Projekt REST API do eksportu danych do Excela i PDF.",
                            Name = "Moduł API do generowania raportów",
                            Price = 2500,
                            StartDate = new DateTime(2025, 8, 27, 16, 55, 24, 3, DateTimeKind.Utc).AddTicks(4888),
                            Status = 1,
                        ...
                        {
                            Id = 20,
                            CreateDate = new DateTime(2025, 8, 5, 16, 55, 24, 3, DateTimeKind.Utc).AddTicks(4890),
                            Description = "Migracja starej aplikacji .NET Framework do .NET 8.",
                            Name = "Refaktoryzacja aplikacji legacy",
                            Price = 9000,
                            StartDate = new DateTime(2025, 8, 13, 16, 55, 24, 3, DateTimeKind.Utc).AddTicks(4890),
                            Status = 0,
            ...
            modelBuilder.Entity("Freelancer.Backend.Domain.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastName = "Smith",
                            Nip = "0123456789",
                            PasswordHash = "AQAAAAIAAYagAAAAEILM1AV5n8vnkxRebJP4MBqbGHoqyyeUISF5TNaVazOXx9/76QI5LyDLPXce973olw==",
                            RoleId = 1,
                        ...
                        new
                        {
                            ...
                            LastName = "Brown",
                            Nip = "1234567890",
                            PasswordHash = "AQAAAAIAAYagAAAAEAH3H6K5ecWTU0nDUMXxqA0V+PMBgYwi9NVtojTrZrv5/hk2qnoQlVQuozUpDa1w9g==",
                            RoleId = 1,
                        ...
                        new
                        {
                            ...
                            LastName = "Kowalska",
                            Nip = "2233445566",
                            PasswordHash = "AQAAAAIAAYagAAAAEMHeLwaTz6P2w2h1NLAfqnsCll1n0zJHRdjMur2BJ6XVl/Rpr0gv2QuHRcJH1fxnpQ==",
                            RoleId = 1,
                        ...
                        new
                        {
                            ...
                            LastName = "Nowak",
                            Nip = "9988776655",
                            PasswordHash = "AQAAAAIAAYagAAAAEPUPOXCynbsoV8LRrVOAcdr2CBkNIb0gBDpwj5jc8CTdVZZUljeAAAIkb5zyRM+MmA==",
                            RoleId = 1,
                        ...
                        new
                        {
                            ...
                            LastName = "Mazur",
                            Nip = "1112223334",
                            PasswordHash = "AQAAAAIAAYagAAAAEF8VOn9wIAvf3c6TORx1Sj9ZUagj42K99hT+lWnDslIBDz5ZyueWCqu9VQTZu3O8wg==",
                            RoleId = 1,
                        ...
                        new
                        {
                            ...
                            LastName = "Zielinski",
                            Nip = "7778889990",
                            PasswordHash = "AQAAAAIAAYagAAAAECxWUNS7FRF1UCgnhCQB80ZVhkmGNm59/pmmGQQbpeAOMUt0MD/sdTUVBdfZtBDIZQ==",
                            RoleId = 1,
                        ...
                        new
                        {
                            ...
                            LastName = "Wisniewska",
                            Nip = "1122334455",
                            PasswordHash = "AQAAAAIAAYagAAAAEDMX4u2tJKcoCuNty8QJeDQZ8Rd5lXgSJUNzjLmzilp6dnM6S5egO2xjrXGVE/lwPQ==",
                            RoleId = 1,
                        ...
                        new
                        {
                            ...
                            Nip = "5566778899",
                            PasswordHash = "AQAAAAIAAYagAAAAEMp0w2lDK0NuPkBwY8mL2+v6/LVetxEvidkmO3RaamJ7blXcSxXQD22ENzitCS+QQA==",
                            RoleId = 1,
                        ...
                        new
                        {
                            ...
                            LastName = "Kaczmarek",
                            Nip = "3322114455",
                            PasswordHash = "AQAAAAIAAYagAAAAEGvn6Vh7l03i2ppKt/8bPruZWDM+7bouB+wQr+Jo4lfhxhI2f8Nw+stPmUWJOW1TTg==",
                            RoleId = 1,
                        ...
                        new
                        {
                            ...
                            LastName = "Wozniak",
                            Nip = "8899001122",
                            PasswordHash = "AQAAAAIAAYagAAAAENiLnh3lBhylWd8/wFiE9n6x2Ct/OCsxAifjlXmAjzqOf3EhIDVWmCYizuCC7TnC8Q==",
                            RoleId = 1,
                        ...
                        new
                        {
                            ...
                            LastName = "Smith",
                            Nip = "0123456789",
                            PasswordHash = "AQAAAAIAAYagAAAAEAc1OQZrTnm+TXq1EDIjZWUu1QYwISpXA1ny6xFiMWh7Mu+5Ak9/vVUedNKe9qBhPQ==",
                            RoleId = 2,
                        ...
                        new
                        {
                            ...
                            LastName = "Jones",
                            Nip = "1231231230",
                            PasswordHash = "AQAAAAIAAYagAAAAEKQ3412QLWf7vpKtvoBojACN1sd1pl6D9Wjfa8XFt3F3ROaT+0Nbb9+uS4fOX9tG5A==",
                            RoleId = 2,
                        ...
                        new
                        {
                            ...
                            LastName = "Malinowski",
                            Nip = "4445556667",
                            PasswordHash = "AQAAAAIAAYagAAAAENAiA489fSPlTlNVIIwamECqNzGOoY+FHOe1WgjLao1oy/J6GL3EIX3z/DdH4zaPwA==",
                            RoleId = 2,
                        ...
                        new
                        {
                            ...
                            LastName = "Adamska",
                            Nip = "1011121314",
                            PasswordHash = "AQAAAAIAAYagAAAAEKjvaIchsxyplY2T53LHVA93URhn5cvhmV0QyQQFhO9sx/O1rc2z2o0IhF2f2OUEzg==",
                            RoleId = 2,
                        ...
                        new
                        {
                            ...
                            LastName = "Kubiak",
                            Nip = "6677889900",
                            PasswordHash = "AQAAAAIAAYagAAAAEO/p+l36U24lgVpUmS7sg3fUeshGSUxEMj2Bmw8A8/j3KPvjTlzvjSztrOfVFWqlNA==",
                            RoleId = 2,
                        ...
                        new
                        {
                            ...
                            LastName = "Olszewska",
                            Nip = "7788990011",
                            PasswordHash = "AQAAAAIAAYagAAAAEG/sOIXLZIzIIyFoqblezYedkhfG4wdwEP2Xn94z6B7c7GO3wvC69vRh1sCMmbodQA==",
                            RoleId = 2,
                        ...
                        new
                        {
                            ...
                            LastName = "Urban",
                            Nip = "5566443322",
                            PasswordHash = "AQAAAAIAAYagAAAAEBDlTOlw6hQiE/7Vn/AFk2X/cO6QkSrbnzuFbD3rMQWNuVV+IUEslEK4cstHfZczDw==",
                            RoleId = 2,
                        ...
                        new
                        {
                            ...
                            LastName = "Dabrowska",
                            Nip = "3344556677",
                            PasswordHash = "AQAAAAIAAYagAAAAEPmmT/q+3BReaYefIVSKnlPy0BF9vMDnvTGsZQ/s6BXn4Y1eTaIgyubKjrNqUOcYxQ==",
                            RoleId = 2,
                        ...
                        new
                        {
                            ...
                            LastName = "Pietrzak",
                            Nip = "2233445566",
                            PasswordHash = "AQAAAAIAAYagAAAAEH0Timbf5hv6ci5bj/KTg2MwqFlsVNva5xJY8hbvBg4OnfEprkaCkhd8SesU/T6BDQ==",
                            RoleId = 2,
                        ...
                        new
                        {
                            ...
                            LastName = "Sawicka",
                            Nip = "9988776655",
                            PasswordHash = "AQAAAAIAAYagAAAAEP1RuxBxyDPjGeIdHHxLZjCmN2dwEiW5HPCp1LQwyaVYYwl1qp5YHVweG8X6IQGTjA==",
                            RoleId = 2,
